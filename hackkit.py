...
def install_tool(choice):
    tools = { 
        ...
        "12" : "git clone https://github.com/omemishra/PhishX-New-Fix.git",
        "13" : "git clone https://github.com/KasRoudra2/PyPhisher.git",
        "14" : "git clone https://github.com/gophish/gophish",
        "15" : "apt-get install metasploit-framwork",
        "16" : "apt-get install exploitdb",
        "17" : "git clone https://github.com/beefproject/beef.git",
        "18" : "git clone https://github.com/DominicBreuker/pspy.git",
